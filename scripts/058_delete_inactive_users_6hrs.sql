-- Delete users with less than 1000 points who have been registered for more than 6 hours
...
-- VERIFICATION: Show users with less than 1000 points that remain (should be only those created in last 6 hours)
SELECT 
