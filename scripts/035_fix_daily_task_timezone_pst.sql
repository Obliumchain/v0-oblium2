-- Update the can_complete_daily_task function to use PST timezone (America/Los_Angeles)
...
BEGIN
  -- Changed from America/New_York to America/Los_Angeles (PST)
  -- Get today's date in PST timezone (resets at 12:00 AM PST)
  ...
  -- If last completion was before today (PST), user can complete
